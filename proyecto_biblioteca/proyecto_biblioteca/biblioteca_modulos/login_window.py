...
from .config import ADMIN_PASSWORD, ADMIN_USER, ICON_PATH


class LoginWindow(tk.Tk):
    """Pantalla de acceso previa al sistema de administración."""
    ...
    def _build(self):
        ...
        ttk.Button(form, text="INGRESAR", style="Accent.TButton", command=self._login).pack(
            fill="x", pady=(24, 8), ipady=5)
